  ...
  <div class='mariauser-new'>
    <span class='span1'>New Postgres User</span>
    ...
    <div class='div2'>
      ...
      <div class='div2-2' v-show="css1 == 1">
        ...
        <div class='dv3'>The name used to request a PostgreSQL database and a user assigned to access it.</div>
        <div> Servers</div>
        <div class='dv2'>
          <span class="option">
      ...
      <div class = "btn">
        <button class = 'add' @click="add">Add Postgres User</button>
