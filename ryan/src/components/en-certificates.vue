a<template>
  <div class="applications" v-show="routers">
    <div class="global-search" :class="{'search':globalsearch ==false}">
      <button class="tianjia" @click="add">十 Add Certificate</button>
      <span>
        <input class="sousuo" @input="sousuochange" v-model="sousuo" placeholder="Search Certificates" />
      </span>
    </div>
   ...
   <div id='certshow'  v-show='iff'>
     ...
     <div id = 'certtext'  class = 'text'>
       <div class = 'text1'>
         ...
         <div class = 'odd'>Certificate</div>
         <div class = 'even texts1'>{{ text1 }}</div>
         <div class = 'odd'>Intermediate Certificate</div>
         <div class = 'even texts2'>{{ text2 }}</div>
         <div class = 'odd'>Key</div>
         <div class = 'even texts3'>{{ text3 }}</div>
         <div class = 'divqd'><button @click="queding" class = "queding">OK</button></div>
       </div>
     </div>
   </div>
  </div>
