<template>
  <div class='mariauser-new'>
    <span class='span1'>新Postgres用户</span>
    ...
    <div class='div2'>
      ...
      <div class='div2-2' v-show="css1 == 1">
        <div class='div2-2-1'>Postgres DB是MySQL兼容的数据库，具有许多增强功能。它由MySQL的原始开发人员制作，并保证保持开源。</div>
        <div>名称</div>
      ...
      <div class = "btn">
        <button class = 'add' @click="add">添加Postgres用户</button>
...
<script>
  ...
  export default {
    ...
    methods: {
      quxiao(){
        this.$router.push({path:'/psqlusers'})
      },
      add() {
         var that =this
         ...
         $.ajax({
            ...
            contentType: "application/json",
              ...
              that.$router.push({path:'/psqlusers'})
            },
