<template>
  <div class="rounew">
    <div class="">
      <div>
        <div class="top">New Site Route</div>
        <div class="div2">
          <div>
        ...
        <div>
          <div>
            <button class="klbtn" @click="addone"><i>十</i>Add Route</button>
          </div>
          <div class="yuxinxi">
        ...
        <div class = "btn">
          <button class = 'add' @click="add">Add Site Route</button>
        ...
        $.ajax({
           ...
           contentType: "application/json",
        	  success: function(data){
               ...
               // alert("添加成功" )
               that.$router.push({path:'/en/routes'})
           },
