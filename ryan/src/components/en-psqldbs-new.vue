<template>
  <div class='mariauser-new'>
    <span class='span1'>New Postgres Database</span>
    ...
    <div class='div2'>
      ...
      <div class='div2-2' v-show="css1 == 1">
        ...
        <div class='div2-2-1'>Postgres DB is a powerful, open source object-relational database system that uses and extends the SQL language.</div>
        <div>Name</div>
        <div class='dv2'><input v-model="input1"></div>
        <div class='dv3'>The name used to request a Postgre DB database and a user assigned to access it.</div>
        <div>Servers</div>
        <div class='dv2'>
          <span class="option">
        ...
        <div class='dv3'>The character set for your Postgre DB database.</div>
        <div>Postgres Read-Write User</div>
        <div class='dv2'>
          <span class="option">
        ...
        <div class='dv3'>Choose a read-write user for this database.</div>
      ...
      <div class = "btn">
        <button class = 'add' @click="add">Add Postgres Database</button>
...
<script>
  ...
  export default {
    ...
    methods: {
      quxiao(){
        this.$router.push({path:'/en/psqldbs'})
      },
      add() {
        var that = this
