<template>
  <div class='mariauser-new'>
    <span class='span1'>New Maria Database</span>
    ...
    <div class='div2'>
      ...
      <div class='div2-2' v-show="css1 == 1">
        ...
        <div class='dv3'>The character set for your Maria DB database.</div>
        <div>Maria Read-Write User</div>
        <div class='dv2'>
          <span class="option">
      ...
      <div class = "btn">
        <button class = 'add' @click="add">Add Maria Database</button>
...
<script>
  ...
  export default {
    ...
    methods: {
      quxiao(){
        this.$router.push({path:'/en/mariadbs'})
      },
      add() {
        var that = this
