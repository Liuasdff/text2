    ...
    <form>
      <div class="text">
        <div class="div2">
          ...
          <div class="names" v-for="(k,i) in loca"> 选定的Postgres用户 {{ k.obj.name }}</div>
          <div class="div2-2">
            <div class='divv2-2'>
              密码在8到64个字符之间。
            </div>
          ...
          <div><input @input="input1" maxlength="254" v-model="newpass" type="password" autocomplete='false' placeholder="新密码"></div>
          <div class="querengpass">确认密码 &nbsp; <span :style="{'color':color2}">{{ text2 }}</span></div>
          <div><input @input="input2" maxlength="254" v-model="querenpass" type="password" autocomplete='false' placeholder="确认密码"></div>
