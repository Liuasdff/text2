<template>
  <div>
    ...
    <div class="bodydiv">
      ...
      <div class="div5"><button @click="add"><i>十</i><span>添加目标邮件用户</span></button></div>
      ...
      <div id="mailnewcl2">
        <div class="clonediv2">
          <div class="div3 div33">
            <input class="mailnewclone1" placeholder="请输入名称" />
            <span class="a">@</span>
      ...
      <div class="save" @click="save"><button class="Save">保存</button></div>
    </div>
